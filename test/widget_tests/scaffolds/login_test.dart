...
void main() {
  ...
  testWidgets("Test login", (WidgetTester tester) async {
    when(inetFactory.userProvider.login('test@hm.edu', '12345678')).thenAnswer((_) => Future.value(user));
    await tester.pumpWidget(new MaterialApp(home: new LoginScreen()));
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Username'), 'test@hm.edu');
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Password'), '12345678');
  ...
  testWidgets("Test invalid data - no username", (WidgetTester tester) async {
    await tester.pumpWidget(new MaterialApp(home: new LoginScreen()));
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Username'), '');
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Password'), '12345678');
    verifyZeroInteractions(inetFactory.userProvider);
    await tester.tap(find.text('Login'));
    await tester.pump();
  ...
  testWidgets("Test invalid data - no password", (WidgetTester tester) async {
    await tester.pumpWidget(new MaterialApp(home: new LoginScreen()));
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Username'), 'test@hm.edu');
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Password'), '');
    verifyZeroInteractions(inetFactory.userProvider);
    await tester.tap(find.text('Login'));
    await tester.pump();
    verifyZeroInteractions(inetFactory.userProvider);
  ...
  testWidgets("Test invalid data - invalid email 1: test@hm", (WidgetTester tester) async {
    await tester.pumpWidget(new MaterialApp(home: new LoginScreen()));
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Username'), 'test@hm');
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Password'), '12345678');
    verifyZeroInteractions(inetFactory.userProvider);
    await tester.tap(find.text('Login'));
    await tester.pump();
  ...
  testWidgets("Test invalid data - invalid email 2: test.hm", (WidgetTester tester) async {
    await tester.pumpWidget(new MaterialApp(home: new LoginScreen()));
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Username'), 'test.hm');
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Password'), '12345678');
    verifyZeroInteractions(inetFactory.userProvider);
  ...
  testWidgets("Test invalid data - invalid email 3: testhm", (WidgetTester tester) async {
    await tester.pumpWidget(new MaterialApp(home: new LoginScreen()));
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Username'), 'testhm');
    await tester.enterText(find.widgetWithText(TextFormField, 'Input Password'), '12345678');
    verifyZeroInteractions(inetFactory.userProvider);
    await tester.tap(find.text('Login'));
    await tester.pump();

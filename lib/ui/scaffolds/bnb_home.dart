      ...
      scaffold = new Scaffold(
        bottomNavigationBar: new BottomNavigationBar(
          ...
          onTap: (newIndex) {
            ...
            new Session().firebaseAnalytics.setCurrentScreen(screenName: "bnb_click_"+screens[newIndex].toStringShort());
          },
        ),
        ...
        body: new PageView(
          ...
          onPageChanged: (newIndex) {
            ...
            new Session().firebaseAnalytics.setCurrentScreen(screenName: "swipe_"+screens[newIndex].toStringShort());
          },
        ),
      );
    } else {

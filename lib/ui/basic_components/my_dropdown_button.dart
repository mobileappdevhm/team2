...
const EdgeInsets _kMenuItemPadding =
...
/// Typically, an enum is used. Each [MyDropdownMenuItem] in [items] must be
...
/// See also:
///
///  * [MyDropdownMenuItem], the class used to represent the [items].
...
class MyDropdownButton<T> extends StatefulWidget {
  ...
  MyDropdownButton({
    ...
    this.isDense: false,
        ...
        assert(value == null ||
            items
                    .where((MyDropdownMenuItem<T> item) => item.value == value)
                    .length ==
                1),
        super(key: key);
...
class _DropdownButtonState<T> extends State<MyDropdownButton<T>>

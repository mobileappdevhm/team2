...
class MockDepartmentProvider implements DepartmentProvider {
  static const Map<int, Department> MOCK_DEPARTMENTS = const <int, Department>{
    ...
    3: const Department(3, "Mechanical, Automotive and Aeronautical Engineering", const Color(0xFF018bc9)),
    4: const Department(4, "Electrical Engineering and Information Technology", const Color(0xFF0198ab)),
    5: const Department(5, "Building Services Engineering, Paper and Packaging Technology and Print and Media Technology", const Color(0xFF016fb2)),
    6: const Department(6, "Applied Sciences and Mechatronics", const Color(0xFF04539d)),
    7: const Department(7, "Computer Science and Mathematics", const Color(0xFF029fd0)),
    ...
    13: const Department(13, "General and Interdisciplinary Studies", const Color(0xFFbf0179)),
    14: const Department(14, "Tourism", const Color(0xFFa41948))
  };

  @override
  Future<Department> getDepartmentByNumber(int departmentNumber) async {
    return new Future.delayed(const Duration(milliseconds: 200), () => MOCK_DEPARTMENTS[departmentNumber]);
  }

  @override
  Future<Iterable<Department>> getDepartments() async {
    return new Future.delayed(const Duration(milliseconds: 300), () => MOCK_DEPARTMENTS.values);
  }
}
